...
# Usage
To execute client, "mvn clean && mvn install && java -Djava.security.policy=client.policy -cp target/classes main.Main" in shell, having installed and in the path maven and java.
